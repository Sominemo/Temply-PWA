export default {
    ...
    timetable: {
        ...
        subject_list_empty: "у вас нет сохранённых предметов",
        where_to_create_subjects: "вы можете создавать новые предметы во время редактирования расписания",
    ...
    loading_error: {
        __index: "Ошибка загрузки",
        alert: "Вот незадача, что-то пошло не так",
        description: "К сожалению, Temply испытывает трудности и не может запуститься.",
        lets_fix: "Давайте исправим это",
        whats_your_browser: "Какой у вас браузер?",
        supported_browsers: "Temply PWA официально поддерживается на новейших версиях браузеров, таких как Google Chrome 73+, Firefox 65+, а также Safari на iOS 12+.",
        your_browser_is: "Нам кажется, что вы используете",
        is_network_stable: "Стабильное ли у вас Интернет соединение?",
        network_troubleshooting: "При слабом интернете Temply может некорректно загрузить языковые пакеты и другие воспомогательные модули, что в следствии и вызывает эту ошибку. Попробуйте перегрузить страницу. Если это не помогает, попробуйте очистить кеш браузера.",
        maybe_its_us: "Возможно, дело в Temply",
        how_to_send_report: "Если вы уверены, что ошибка произошла по вине Temply, сообщите об этом, нажав на кнопку \"Отправить\".",
        send: "Отправить",
