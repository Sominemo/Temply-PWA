export default {
    ...
    loading_error: {
        ...
        description: "К сожалению, Temply не удалось запуститься",
        lets_fix: "Давайте исправим это",
        troubleshooting: "Прочтите нашу справочную статью и устраните проблему",
        maybe_its_us: "Возможно, дело в Temply",
        how_to_send_report: "Сообщите нам о неполадке, если она была вызвана Temply",
        send: "Сообщить",
