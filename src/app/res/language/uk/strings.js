export default {
    ...
    loading_error: {
        ...
        alert: "От халепа, щось пшло не так",
        description: "Нажаль, Temply не вдалося завантажитись.",
        lets_fix: "Давайте це виправляти",
        whats_your_browser: "Який у вас браузер?",
        supported_browsers: "Temply PWA офіційно підтримується на нових версіях браузерів, таких як Chrome 73+, Firefox 65+, а також Safari на iOS 12+.",
        your_browser_is: "Нам здається, що ви використовуєте",
        is_network_stable: "Чи стабільне Інтернет з'єднання?",
        network_troubleshooting: "За слабкої мережі Temply може невдало завантажувати мовні пакети та інші додаткові модулі, що у висновку й зчиняє цю помилку. Спробуйте перезавантажити сторінку. Якщо це не допомагає, очистіть кеш браузера.",
        maybe_its_us: "Можливо, справа у Temply",
        how_to_send_report: "Якщо ви впевнені, що помилка виникла через Temply, повідомте нам про це, натиснувши на кнопку \"Надіслати\".",
        send: "Надіслати",
